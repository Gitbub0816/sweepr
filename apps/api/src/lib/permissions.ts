...
const SCREENS: Array<{ slug: string; label: string; route: string }> = [
  ...
  { slug: "pricing_studio", label: "Pricing Studio", route: "/pricing-studio" },
...
const CONTENT: PermissionDef[] = [
  ...
  { key: "content.pricing.publish", label: "Publish pricing versions (Pricing Studio)" },
  { key: "content.pricing.advanced_model", label: "Edit advanced prediction-model settings (Pricing Studio)" },
...
const ROLE_CONTENT_DEFAULTS: Record<string, string[]> = {
  ...
  finance: ["content.pricing.edit", "content.pricing.publish", "content.payouts.release", "content.approvals.decide"],
