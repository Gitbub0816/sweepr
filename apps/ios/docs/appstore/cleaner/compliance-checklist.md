...
| **5.1.1(v)** Account deletion | Missing in-app deletion | SHIPPED: Account → Delete account performs the confirm-by-typing flow and calls POST /account/delete. |
...
- [x] In-app account deletion ships on the Account screen (5.1.1(v)); lawful
      retention of payout/tax records is noted in review-notes.
