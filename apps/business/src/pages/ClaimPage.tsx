    ...
    return (
      <AuthLayout title="Invalid link" subtitle="This claim link is missing its token.">
        <ErrorState
          ...
          action={<Link to="/dashboard" className="text-sm font-medium text-seafoam-700 hover:underline dark:text-seafoam-400">Go to dashboard</Link>}
        />
      </AuthLayout>
    );
  }
  ...
  return (
    <AuthLayout title="Claim your workspace" subtitle="Finishing setup…">
      <div className="w-full max-w-sm">
        ...
        {status === "done" && (
          <div className="flex flex-col items-center rounded-2xl border border-seafoam-200 bg-white p-8 text-center shadow-sm dark:border-slate-700 dark:bg-slate-900">
            <CheckCircle2 className="h-10 w-10 text-seafoam-600" />
