...
DO $$ BEGIN
  ALTER TABLE promotions ADD CONSTRAINT promotions_design_version_check CHECK (design_version IN (1, 2));
EXCEPTION WHEN duplicate_object THEN NULL; WHEN duplicate_table THEN NULL;
END $$;

DO $$ BEGIN
  ALTER TABLE promotions ADD CONSTRAINT promotions_created_via_check CHECK (created_via IN ('console', 'mcp'));
EXCEPTION WHEN duplicate_object THEN NULL; WHEN duplicate_table THEN NULL;
END $$;
...
-- ─────────────────────────────────────────────────────────────────────────
-- 109_retire_sweepr_coverage_program.sql
-- ─────────────────────────────────────────────────────────────────────────
/*
 * Copyright © 2026–Present ClearKey Solutions, LLC.
 * All Rights Reserved.
...
-- ─────────────────────────────────────────────────────────────────────────
-- 110_mobile_broker_sessions.sql
-- ─────────────────────────────────────────────────────────────────────────
-- Copyright © 2026–Present ClearKey Solutions, LLC.
-- Proprietary & Confidential. Internal Use Only.
--
