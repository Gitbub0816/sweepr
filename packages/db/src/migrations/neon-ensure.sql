...
-- ============================================================================
-- Paste into the Neon SQL editor (or run via psql) to GUARANTEE every table,
-- column, index, constraint, type and the migration-tracking table exist and
-- are shaped correctly. Safe to re-run; never drops data. Not auto-run by the
-- migration runner (it isn't numbered).
-- ============================================================================
