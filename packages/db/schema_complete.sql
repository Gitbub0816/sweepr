-- ============================================================================
-- Sweepr — COMPLETE CONSOLIDATED SCHEMA  (migrations 001–024)
--
-- Safe to run on a fresh Neon database using the SQL editor.
-- All statements use IF NOT EXISTS / IF EXISTS guards and are idempotent.
-- Run this ONCE against a new database to bootstrap the full schema.
-- ============================================================================
...
-- ============================================================================
-- Migrations 016 onward (appended to consolidated schema)
-- ============================================================================
...
-- ─────────────────────────────────────────────────────────────────────────
-- Cleaner preferences columns (needed for DashboardPage settings tab)
-- ─────────────────────────────────────────────────────────────────────────
ALTER TABLE cleaners
  ADD COLUMN IF NOT EXISTS max_jobs_per_day         INTEGER         DEFAULT 3,
  ADD COLUMN IF NOT EXISTS max_distance_miles       NUMERIC(6,2)    DEFAULT 25,
  ADD COLUMN IF NOT EXISTS accepts_last_minute      BOOLEAN         DEFAULT TRUE,
  ADD COLUMN IF NOT EXISTS notification_job_offer   BOOLEAN         DEFAULT TRUE,
  ADD COLUMN IF NOT EXISTS notification_reminder    BOOLEAN         DEFAULT TRUE,
  ...
  ADD COLUMN IF NOT EXISTS preferred_service_types  JSONB           DEFAULT '["standard","deep"]'::jsonb,
